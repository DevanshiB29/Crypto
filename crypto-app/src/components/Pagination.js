  ...
  return (
    <div className='flex item-center'>
      ...
      <ul className='flex item-center justify-end text-sm'>
        ...
        {
          page+1 !== TotalNumber && page !== TotalNumber ? <li><button onClick={multiStepNext} className='outline-0 hover:text-cyan rounded-full w-8 h-8 flex items-center justify-center text-lg'>...</button></li>
              : null
        }
